...
export function Delete({ color = DEFAULT_ICON_COLOR, size = 20, className = '' }) {
  return _jsx('svg', {
    ...
    children: _jsx('path', {
      d: 'M4.99996 15.8333C4.99996 16.75 5.74996 17.5 6.66663 17.5H13.3333C14.25 17.5 15 16.75 15 15.8333V7.5C15 6.58333 14.25 5.83333 13.3333 5.83333H6.66663C5.74996 5.83333 4.99996 6.58333 4.99996 7.5V15.8333ZM7.49996 7.5H12.5C12.9583 7.5 13.3333 7.875 13.3333 8.33333V15C13.3333 15.4583 12.9583 15.8333 12.5 15.8333H7.49996C7.04163 15.8333 6.66663 15.4583 6.66663 15V8.33333C6.66663 7.875 7.04163 7.5 7.49996 7.5ZM12.9166 3.33333L12.325 2.74167C12.175 2.59167 11.9583 2.5 11.7416 2.5H8.25829C8.04163 2.5 7.82496 2.59167 7.67496 2.74167L7.08329 3.33333H4.99996C4.54163 3.33333 4.16663 3.70833 4.16663 4.16667C4.16663 4.625 4.54163 5 4.99996 5H15C15.4583 5 15.8333 4.625 15.8333 4.16667C15.8333 3.70833 15.4583 3.33333 15 3.33333H12.9166Z',
      fill: color,
    }),
  });
}
