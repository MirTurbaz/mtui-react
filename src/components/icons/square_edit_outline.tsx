...
export function SquareEditOutline({ className = null, color = DEFAULT_ICON_COLOR, size = 16 }: ISquareIconProps) {
  return (
    <svg
      width={size}
      height={size}
