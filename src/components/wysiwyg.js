...
export const Wysiwyg = (props) => {
    ...
    //@ts-ignore
    return (_jsx(Editor, { editorState: editorState, wrapperClassName: `wysiwyg_editor__wrapper margin-top-8 ${focused && 'wysiwyg_editor__wrapper-focused'} ${props.className}`, editorClassName: 'wysiwyg_editor', onEditorStateChange: updateState, onFocus: () => setFocused(true), stripPastedStyles: true, 
        //@ts-ignore
        blockRenderMap: Draft.DefaultDraftBlockRenderMap.merge(blockRenderMap), onBlur: (e) => {
            ...
            inline: {
                ...
                bold: {
                    icon: 'data:image/svg+xml,<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">' +
